...
const getInitCodeHash = async (publicClient, entryPointAddress, kernelVersion) => {
    const entryPointVersion = (0, permissionless_1.getEntryPointVersion)(entryPointAddress);
    (0, sdk_1.validateKernelVersionWithEntryPoint)(entryPointAddress, kernelVersion);
...
async function getKernelAddressFromECDSA(params) {
    ...
    (0, sdk_1.validateKernelVersionWithEntryPoint)(params.entryPointAddress, params.kernelVersion);
    const kernelAddresses = sdk_1.constants.KernelVersionToAddressesMap[params.kernelVersion];
    const ecdsaValidatorAddress = (0, toECDSAValidatorPlugin_js_1.getValidatorAddress)(params.entryPointAddress, params.kernelVersion);
    const bytecodeHash = await (async () => {
        ...
        if ("publicClient" in params && params.publicClient) {
            return await getInitCodeHash(params.publicClient, params.entryPointAddress, params.kernelVersion);
        }
