...
export async function getKernelAddressFromECDSA(params) {
    ...
    validateKernelVersionWithEntryPoint(params.entryPointAddress, params.kernelVersion);
    const kernelAddresses = constants.KernelVersionToAddressesMap[params.kernelVersion];
    const ecdsaValidatorAddress = getValidatorAddress(params.entryPointAddress, params.kernelVersion);
