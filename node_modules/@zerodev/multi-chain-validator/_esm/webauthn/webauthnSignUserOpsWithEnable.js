...
import { concatHex, encodeAbiParameters, getAbiItem, hashMessage, hashTypedData, keccak256, toFunctionSelector, zeroAddress } from "viem";
/**
 *
 * @dev Sign user operations with enable signatures for multi-chain validator
 * @returns Signed user operations
 */
export const webauthnSignUserOpsWithEnable = async ({ multiChainUserOpConfigsForEnable }) => {
