...
export async function toMultiChainWebAuthnValidator(client, { webAuthnKey, entryPoint: entryPointAddress, kernelVersion: _, rpId, validatorAddress }) {
    const currentValidatorAddress = validatorAddress ?? MULTI_CHAIN_WEBAUTHN_VALIDATOR_ADDRESS;
    // Fetch chain id
...
export async function deserializeMultiChainWebAuthnValidator(client, { serializedData, entryPoint: entryPointAddress, kernelVersion }) {
