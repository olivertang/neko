...
const createKernelAccountClient = (parameters) => {
    ...
    const client = (0, viem_1.createClient)({
        ...
        transport: (opts) => {
            ...
            if (!shouldIncludePimlicoProvider ||
                ...
                (0, utils_js_1.isProviderSet)(_bundlerTransport.value?.url, "THIRDWEB") ||
                (0, utils_js_1.isProviderSet)(_bundlerTransport.value?.url, "CONDUIT"))
    ...
    if ((!middleware ||
        ...
        ((0, utils_js_1.isProviderSet)(client.transport.url, "PIMLICO") ||
            (0, utils_js_1.isProviderSet)(client.transport.url, "THIRDWEB") ||
